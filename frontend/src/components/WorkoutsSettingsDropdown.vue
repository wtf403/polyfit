<template>
  <div class="dropdown__block" tabindex="1" @focus="dropdownActive=true" @blur="dropdownActive = false">
    <div class="dropdown__wrapper">
      ...
      <button class="dropdown__dropdown-button" @focus="dropdownActive=true" @blur="dropdownActive=false">
        <svg focusable="false" class="dropdown__dropdown-icon" width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
