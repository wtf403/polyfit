...
func (r *repository) Create(ctx context.Context, ex Exercise) (exID string, err error) {
...
func (r *repository) FindOne(ctx context.Context, id string) (*Exercise, error) {
	tx, err := r.client.Begin(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *repository) FindAll(ctx context.Context) (ex *[]Exercise, err error) {
	tx, err := r.client.Begin(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *repository) Update(ctx context.Context, id string, ex Exercise) (err error) {
	tx, err := r.client.Begin(ctx)
	if err != nil {
		return err
	}
